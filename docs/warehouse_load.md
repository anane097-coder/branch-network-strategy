...
| `fact_tract_competition` | 4,807 |
| `fact_county_deposit_growth` | 174 |
| `ref_index_weights` | 20 |
...
| fact_tract_competition.tract_geoid -> dim_tract | 0 |
| dim_tract -> fact_tract_competition (coverage) | 0 |
| fact_county_deposit_growth.county_fips -> dim_tract | 0 |
| dim_tract.county_fips -> fact_county_deposit_growth (coverage) | 0 |
